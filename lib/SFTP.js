...
var FTPUtils = /** @class */ (function () {
    ...
    FTPUtils.prototype.uploadFlies = function (fileList, remoteEntry) {
        var _this = this;
        return new Promise(function (resovle) { return __awaiter(_this, void 0, void 0, function () {
            var _i, fileList_2, uploadFile, localFile, remoteFile, status_2, result, remoteDir, existInRemote, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < fileList_2.length)) return [3 /*break*/, 10];
                        uploadFile = fileList_2[_i];
                        localFile = uploadFile;
                        remoteFile = remoteEntry + path.basename(uploadFile);
                        return [4 /*yield*/, (0, fileUtils_1.stat)(localFile)];
                    case 2:
                        status_2 = _a.sent();
                        if (!status_2.isDirectory()) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.client
                                .uploadDir(localFile, remoteFile)["catch"](function (err) {
                                (0, tools_1.log)("upload dir error: " + err, "red");
                            })];
    ...
    FTPUtils.prototype.download = function (fileList, localEntry, remoteEntry) {
        var _this = this;
        return new Promise(function (resovle) { return __awaiter(_this, void 0, void 0, function () {
            var _i, fileList_3, uploadFile, remoteFile, localFile, writeStream, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _i = 0, fileList_3 = fileList;
                        _a.label = 1;
                    case 1:
                        if (!(_i < fileList_3.length)) return [3 /*break*/, 5];
                        uploadFile = fileList_3[_i];
                        remoteFile = remoteEntry + uploadFile;
                        localFile = path.join(localEntry, uploadFile);
