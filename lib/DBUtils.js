...
var DBUtils = /** @class */ (function () {
    ...
    DBUtils.prototype.getJtracByVersion = function (version) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            _this.connection.query("SELECT * FROM ".concat(DB_JTRAC_LIST, " WHERE version = ? AND system_type = 'mp' AND status = 'A'"), [version], function (error, results, fields) {
                if (error) {
                    throw error;
                    reject(error);
                }
    ...
    DBUtils.prototype.getJtracByVersionAndType = function (version, type) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            _this.connection.query("SELECT * FROM ".concat(DB_JTRAC_LIST, " WHERE version = ? AND system_type = ? AND status = 'A'"), [version, type], function (error, results, fields) {
                if (error) {
                    throw error;
                    reject(error);
                }
